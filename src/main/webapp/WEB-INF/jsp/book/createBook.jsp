...
<div class="content-wrapper">
	...
	<h1>
		<spring:message code="book.create.title"></spring:message>
	</h1>
	</section>
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form:form method="POST" commandName="book" action="/createBook">
					<div class="box-body">
						<div class="form-group col-sm-6 col-sm-offset-3">
							<label><spring:message code="book.create.lbl.title"></spring:message>
						...
						<div class="form-group col-sm-6 col-sm-offset-3">
							<label><spring:message code="book.create.lbl.description"></spring:message>
								<span class="error">*</span></label>
					...
					<div class="box-footer">
						<div class="col-sm-6 col-sm-offset-3">
							...
							<button type="submit" class="btn btn-primary pull-right ">
								<spring:message code="book.create.btn.submit"></spring:message>
							</button>
						</div>
					</div>
				</form:form>
